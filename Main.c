...
//
// Version 1.1  Improved encoder action. Encoder function moved inside ISR to 
//              prevent miss-stepping if processor busy. Flags are read by FSM 
//              outside of ISR using a simple read function. Encoder press tone
//              added.
//------------------------------------------------------------------------------
//
// Include Files
