...
// event and the current state
   ...
   static state_matrix state_trans[]={
    ...
    {ST_FILTER,         EV_ENC_A_PRESS, (*freq_2_sel)},        // Enter adjustment
    ...
    {ST_ANOTCH,         EV_ENC_A_PRESS, (*autonotch_toggle)},  // Toggle Autonotch
    ...
    {ST_DENOISE,        EV_ENC_A_PRESS, (*denoiser_in)},       // Engage Denoiser    
    ...
    {ST_BINAURAL,       EV_ENC_A_PRESS, (*binaural_in)},       // Toggle Binaural on
    ...
    {ST_TONE_GAIN,      EV_ENC_A_PRESS, (*tone_gain_adj)},     // Enter adjustment
    ...
    {ST_PRESET,         EV_ENC_A_PRESS, (*save_preset)},       // Enter adjustment
    ...
    {ST_BINAURAL_BAL,   EV_ENC_A_PRESS, (*binaural_out)},      // Toggle Binaural off
    ...
    {ST_MENU_START,     EV_ENC_A_PRESS, (*freq_2_sel)},         // Enter adjustment
