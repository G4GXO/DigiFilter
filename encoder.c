...
// to prevent unintentional encoder change whilst operating switch. Flags bits are
// OR'd into flag word and individually cleared. This individual treatment prevents 
// a flag from being overwritten by a new one.    
...
//******************************************************************************
// Encoder Flags Read
// Return encoder flags word to caller
//
int enc_A_read(){
    return enc_A_flags;
}
